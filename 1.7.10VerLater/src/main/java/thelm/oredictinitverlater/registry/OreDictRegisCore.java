...
public class OreDictRegisCore {
	...
	public static void yayCompat() {
		...
		if(Compat.EL) {
			Woodchopper.info("Loading Elysium Compat");
			Elysium.ore();
		}
	...
	public static class BlockNotFoundException extends Exception {
		public BlockNotFoundException(String mod, String item) {
			super("Unable to find block \"" + mod + ":" + item + "\". Either it doesn't exist or is truly a poorly registered block.");
		}
	}
	
	public static class ItemNotFoundException extends Exception {
		public ItemNotFoundException(String mod, String item) {
			super("Unable to find item \"" + mod + ":" + item + "\". Either it doesn't exist or truly is a poorly registered item.");
		}
	}
}
